...
@pytest.fixture()
def apigw_get_with_unsafe_query_params_event():
    return read_filepath_content("./events/get_with_unsafe_query_params.json")
...
@mock.patch.dict(os.environ, { "TargetHostTemplate": "internal-<original_host>", "TargetProtocol": "https", "RetriedHttpStatuses": "429,503" })
@responses.activate
...
@mock.patch.dict(os.environ, { "TargetHostTemplate": "private-<original_host>", "TargetProtocol": "http", "RetriedHttpStatuses": "429" })
@responses.activate
...
def test_safe_query_params_are_not_encoded(apigw_get_with_unsafe_query_params_event):
    def request_callback(request):
        assert request.path_url == "/thepath?param1=t[value1]"
        return (200, {}, b"{}")
